...
class Build : NukeBuild
{
    ...
    {
        // Copy UI files
        CopyDirectoryRecursively(SourceDirectory / "Vendr.Contrib.Wishlists" / "Web" / "UI", ArtifactFilesDirectory);
    ...
    private void PackNuGetPackages()
    {
        ...
        var nuSpecsFile = nuSpecsDir / $"Vendr.Contrib.Wishlists.nuspec";
        ...
        NuGetPack(c => c
            ...
            .SetProperties(new Dictionary<string, object>
            {
                ...
                { "ProjectDirectory", SourceDirectory / "Vendr.Contrib.Wishlists" },
    ...
    private void PackUmbracoPackage()
    {
        ...
        var vendrUmbracoPackageXmlFile = umbracoPackageXmlDir / $"Vendr.Contrib.Wishlists.package.xml";
